...
int usbmain(){
    ...
    int products[] = {
        // Keyboards
        P_K55, P_K63_NRGB, P_K65, P_K65_NRGB, P_K65_LUX, P_K65_RFIRE, P_K68, P_K70, P_K70_NRGB, P_K70_LUX, P_K70_LUX_NRGB, P_K70_RFIRE, P_K70_RFIRE_NRGB, P_K95, P_K95_NRGB, P_K95_PLATINUM, P_STRAFE, P_STRAFE_NRGB, P_STRAFE_NRGB_2,
        // Mice
